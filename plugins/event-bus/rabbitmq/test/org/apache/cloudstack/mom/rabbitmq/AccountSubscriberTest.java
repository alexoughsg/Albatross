...
public class AccountSubscriberTest extends TestCase {

    private AccountSubscriber subscriber;

    @Override
    @Before
    public void setUp() {
        subscriber = new AccountSubscriber(1) {
            ...
            protected AccountDao getAccountDao() {
                ...
                Mockito.when(accountDao.findByUuidIncludingRemoved(Mockito.any(String.class))).thenReturn(account);
