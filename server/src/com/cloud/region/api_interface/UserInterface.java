...
public class UserInterface extends BaseInterface {
    ...
    public JSONArray listUsers(String domainId, String accountName) throws Exception
    {
        ...
        String paramStr = "command=listUsers&listAll=true&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
    ...
    {
        String paramStr = "command=listUsers&id=" + uuid + "&listAll=true&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        JSONObject retJson = sendApacheGet(paramStr);
        if (!BaseService.hasAttribute(retJson, "user"))
        {
            return null;
    ...
    {
        String paramStr = "command=deleteUser&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
    ...
    {
        String paramStr = "command=updateUser&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
    ...
    {
        String paramStr = "command=lockUser&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        return sendApacheGet(paramStr);
    }

    public JSONObject disableUser(String userId) throws Exception
    {
        String paramStr = "command=disableUser&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        return sendApacheGet(paramStr);
    }

    public JSONObject enableUser(String userId) throws Exception
    {
        String paramStr = "command=enableUser&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        return sendApacheGet(paramStr);
    }

    public JSONObject getUser(String userAPIKey) throws Exception
    {
        String paramStr = "command=getUser&userapikey=" + userAPIKey + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        return sendApacheGet(paramStr);
    }

    public JSONObject registerUserKeys(String userId) throws Exception
    {
        String paramStr = "command=registerUserKeys&id=" + userId + "&response=json&sessionkey=" + URLEncoder.encode(getSessionKey(), "UTF-8");
        return sendApacheGet(paramStr);
    }
}