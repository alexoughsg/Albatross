...
public class LocalAccountManager {
    ...
    public Object create(JSONObject jsonObject, final Date created) throws Exception
    {
        ...
        return accountManager.createAccount(accountName, accountType, domainId, networkDomain, accountDetails, accountUUID, state, created);
    }
    ...
    public void update(Object object, JSONObject jsonObject, Date modified)
    {
        ...
        accountManager.updateAccount(account, newAccountName, newNetworkDomain, accountDetails, state, modified);
