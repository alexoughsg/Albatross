...
public class LocalUserManager {
    ...
    public Object create(JSONObject jsonObject, Date created) throws Exception
    {
        ...
        User user = accountManager.createUser(userName, password, firstName, lastName, email, timezone, accountName, domain.getId(), userUUID, state, created);
    ...
    public void update(Object object, JSONObject jsonObject, Date modified)
    {
        ...
        accountManager.updateUser(user.getId(), userName, firstName, lastName, password, email, apiKey, secretKey, timezone, state, modified);
